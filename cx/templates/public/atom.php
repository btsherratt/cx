...
<feed xmlns="http://www.w3.org/2005/Atom">
	...
	<link href="<?= cx_url('/feed/'); ?>" rel="self" type="application/atom+xml" />
...
<?php $post_permalink = '/' . date('Y', $post->date) . '/' . date('m', $post->date) . '/' . $post->slug; ?>
	<entry>
		...
		<content xml:lang="en" xml:base="<?= cx_url($post_permalink) ?>" type="html"><?= htmlentities($post->html_content) ?></content>
	</entry>
<?php endforeach; ?>
